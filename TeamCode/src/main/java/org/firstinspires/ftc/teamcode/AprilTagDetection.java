...
public class AprilTagDetection extends OpenCvPipeline
{
    ...
    public AprilTagDetection(double tagsize, double fx, double fy, double cx, double cy)
    {
    ...
    public void finalize()
    {
        ...
        {
            System.out.println("AprilTagDetection.finalize(): nativeApriltagPtr was NULL");
        }
    }
    ...
    public ArrayList<org.openftc.apriltag.AprilTagDetection> getLatestDetections()
    {
        return detections;
    }
    ...
    public ArrayList<org.openftc.apriltag.AprilTagDetection> getDetectionsUpdate()
    {
        synchronized (detectionsUpdateSync)
        {
            ArrayList<org.openftc.apriltag.AprilTagDetection> ret = detectionsUpdate;
